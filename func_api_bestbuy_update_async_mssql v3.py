...
# dotenv_path = r'C:\Users\Admin\Documents\Projects\bestbuy\.env'
...
async def best_buy(req, index=0, page_size=100, batch_size=5, db=False):
    ...
    if db or index == 3:
        ...
        connection_string = os.environ['bestbuy_sql_odbc_string']
        sql_params = quote_plus(connection_string)
    ...
    # * send email 
    # if pages > 0: # * if number of pages greater than 0
